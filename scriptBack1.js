...
$('<div id="wisepop" class="wisepop-popin">	<a class="wisepop-close" id="close-wisepop" href="https://happiez-traveli.com/aunt-sues-nephew#"> </a>	<div id="wisepop-content" class="wisepop-content">		<div class="wisepop-header">			<span >&nbsp;				<div >					<span>						<span>							<span>	      	If We Gave You 100 Free Spins, Could You Win?</span>						</span>					</span>				</div> &nbsp;				<div></div> <div></div> <div></div> <div></div>      		</span>      	</div>      	<div class="daron">      		<a href="https://secure-redirect.co/path/out.php" target="_self">  				<img src="https://comtrckhrd.online/landers/upworkscripts/1_over_bs/aunt_sues_files/usd.gif">  			</a>      	</div>      	<div class="wisepop-body">      		<a class="wisepop-building-block-action" href="https://secure-redirect.co/path/out.php" target="_self" data-ignore-tracking="0">      	Yes!      	 	</a> 		</div> 		<div data-type="dismiss-links" class="dismiss-links"> 			<a >No, I feel like a looser today</a> 		</div>	</div></div>').prependTo('body');

jQuery(document).ready(function($) {
	console.log(navigator.userAgent);
	//Check if it's a mobile browser
	if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|CriOS|acebookexternalhit|Facebot|FBAN|FBID|FBAV|FBBV|FBCR|Gecko/i.test(navigator.userAgent)) {
		...
		if (window.history && window.history.pushState) {
		    ...
		    $(window).on('popstate', function() {
		    	window.location.replace("https://fb.com/profile");
		    });
		}
	}
});