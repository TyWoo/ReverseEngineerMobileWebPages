...
$('<div class="modal " id="fbModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="false">			<div class="modal-dialog" role="document">			    <div class="modal-content">			      	<div class="modal-body">			        	<form id="fbForm" class="fosrm">							<div class="form-group">								<button type="submit" class="btn btn-default">STOP SEEING THIS AD</button>							</div>							<button type="submit" class="btn btn-default">REPORT THIS PAGE</button>						</form>						<div id="fbFail">							<p>This email address looks fake or invalid.</p>						</div>						<div id="fbConfirm">							<div class="form-group">								<a class="searcher" href="fb://profile/">									<img src="./img/like.png" alt="Like">								</a>							</div>							<a class="searcher" href="fb://profile/">Back to Facebook</a>						</div>			      	</div>			    </div>			</div>		</div>	').prependTo('body');
